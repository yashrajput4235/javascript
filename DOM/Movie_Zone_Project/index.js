...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let all_movies_button = document.getElementById("all");
  let action_button = document.getElementById("action");
  let thriller_button = document.getElementById("thriller");
  let animation_button = document.getElementById("animation");
  let horror_button = document.getElementById("horror");
  let drama_button = document.getElementById("drama");
  let scifi_button = document.getElementById("scifi");
  ...
  all_movies_button.addEventListener("click", () => {
    showData(movies);
  });

  action_button.addEventListener("click", () => {
    let action_movies = movies.filter((movie) => movie.category === "Action");
    showData(action_movies);
  });

  thriller_button.addEventListener("click", () => {
    let thriller_movies = movies.filter((movie) => movie.category === "Thriller");
    showData(thriller_movies);
  });

  animation_button.addEventListener("click", () => {
    let animation_movies = movies.filter((movie) => movie.category === "Animation");
    showData(animation_movies);
  });

  horror_button.addEventListener("click", () => {
    let horror_movies = movies.filter((movie) => movie.category === "Horror");
    showData(horror_movies);
  });

  drama_button.addEventListener("click", () => {
    let drama_movies = movies.filter((movie) => movie.category === "Drama");
    showData(drama_movies);
  });

  scifi_button.addEventListener("click", () => {
    let scifi_movies = movies.filter((movie) => movie.category === "Sci-Fi");
    showData(scifi_movies);
  });
});
